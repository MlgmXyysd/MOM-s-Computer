...
$(function () {
    $('<IMG>').attr('src', 'images/MOM_eyelid.png');
    $('<IMG>').attr('src', 'images/xbutton_over.png');
    $('<IMG>').attr('src', 'images/popup.png');
    $('<IMG>').attr('src', 'images/loading_anim.gif');
});
...
function consoleOpen() {
	...
	consoleWrite('MOM Operating System\n版本 2.0.2.2 [Build 2009]\n(C) 2009 World of Goo Corporation. 保留所有权利\n');
...
david    pts/1    2a01:550:8000:10f::1:1  01Apr    5:25m  rm -fr /var/lib/MOM\n\
');
            break;
        case 'shutdown':
        case 'reboot':
